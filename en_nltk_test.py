...
print(tokenizer.tokenize('Something about the west wing'.split()))
print(tokenizer.tokenize('set the oven to one hundred and twenty temperature'.split()))
print('-----')
